...
(function () {
  ...
  var ICONS = {
    ...
    refiCalc: '<rect x="4" y="2" width="16" height="20" rx="2"/><line x1="8" y1="7" x2="16" y2="7"/><circle cx="8" cy="12" r="1"/><circle cx="12" cy="12" r="1"/><circle cx="16" cy="12" r="1"/><circle cx="8" cy="16" r="1"/><circle cx="12" cy="16" r="1"/><circle cx="16" cy="16" r="1"/>',
  ...
  function render(adv, toolGroups) {
    ...
    if (adv.is_owner) {
      ...
      NAV.push({ key: 'leady', icon: ICONS.leady, href: '/leady.php', label: 'Kontakty', active: isLeady });
    }
    ...
    var html =
      ...
      '<div id="appRail">' +
        ...
        '<div class="rbot">' +
          ...
          '<a class="ri" href="/api/logout.php" title="Odhlásiť" onclick="return confirm(\'Naozaj sa odhlásiť z tohto zariadenia?\');">' + svg(ICONS.logout) +
          '<span class="tip">Odhlásiť</span></a>' +
